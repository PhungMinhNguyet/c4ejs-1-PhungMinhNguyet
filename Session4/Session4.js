 ...
 for (let i = 0; i < jobData.hits.length; i++) {
     allListJobs.push(jobData.hits[i]);

 }
 console.log(`Job hits:`);
 console.log(allListJobs);
 ...
 console.log(`Job hits:`);
 let listBen = jobData.hits[0].benefits;
 console.log('1st job benefits:')
 for (let i = 0; i < listBen.length; i++) {

     console.log(`- ${listBen[i].benefitValue}`);
 }
 ...
 for (let i = 0; i < cmds.length; i++) {
     ...
     if (cmds[i].shape == 'square' && i == (cmds.length) - 1) {
