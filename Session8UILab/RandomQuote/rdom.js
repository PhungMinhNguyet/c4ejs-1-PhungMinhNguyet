...
function reLoad() {
    for (let i = 0; i < container.length; i++) {
        ...
        let quoteAu = document.getElementById("author");
        let num = Math.floor(Math.random() * container.length);
        quoteT.innerHTML = container[num].quoteText;
        quoteAu.innerHTML = container[num].quoteAuthor;
